 ...
 */
public class TestLinkCreateBuildExecution extends AbstractSynchronousNonBlockingStepExecution<java.lang.Void>{

    @Inject
    private transient TestLinkCreateBuildStep config;
    ...
    protected Void run() throws Exception{
        ...
        builder.getTestLinkSite(testLinkUrl,
                testLinkDevKey,
                config.getTestProjectName(),
                config.getTestPlanName(),
                config.getPlatformName(),
