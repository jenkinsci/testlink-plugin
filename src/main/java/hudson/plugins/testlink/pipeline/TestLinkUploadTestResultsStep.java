 ...
 */
public class TestLinkUploadTestResultsStep extends AbstractStepImpl implements Serializable {
    ...
    public static final class DescriptorImpl extends AbstractStepDescriptorImpl {
        public static final String STEP_NAME = "testLinkUploadTestResults";

        public DescriptorImpl(){
            super(TestLinkUploadTestResultsExecution.class);
